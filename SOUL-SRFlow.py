...
parser.add_argument("--d_scale", type = float, default = 0.1, help = "Standard deviation for kernel")
parser.add_argument("--d_exp", type = float, default = 0.6, help = "Standard deviation for kernel")
parser.add_argument("--b_niter", type = int, default = 20, help = "Standard deviation for kernel")
parser.add_argument("--mn", type = int, default = 5, help = "Standard deviation for kernel")
parser.add_argument("--niter", type = int, default = 60000, help = "Standard deviation for kernel")
parser.add_argument("--step_size", type = float, default = 5e-5, help = "Standard deviation for kernel")
parser.add_argument("--sigma_z", type = float, default = 0.95, help = "Standard deviation for kernel")
