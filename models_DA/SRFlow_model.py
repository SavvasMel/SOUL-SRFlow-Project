...
from utils.load_models import get_resume_paths, opt_get

import torch
import torch.nn as nn
from torch.nn.parallel import DataParallel, DistributedDataParallel
import models_DA.networks as networks
import models_DA.lr_scheduler as lr_scheduler
from models_DA.base_model import BaseModel
    ...
    def __init__(self, opt, step):
        ...
        if opt['dist']:
            ...
            if opt['gpu_ids'] == None:
                ...
                self.netG = DataParallel(self.netG, device_ids=opt['gpu_ids'])
        # print network
        self.print_network()
