...
import models_DA.modules.Split
from models_DA.modules import flow, thops
from models_DA.modules.Split import Split2d
from models_DA.modules.glow_arch import f_conv2d_bias
from models_DA.modules.FlowStep import FlowStep
...
class FlowUpsamplerNet(nn.Module):
    ...
    def arch_split(self, H, W, L, levels, opt, opt_get):
        ...
        if opt_get(opt, ['network_G', 'flow', 'split', 'enable']):
            ...
            if t == 'Split2d':
                split = models_DA.modules.Split.Split2d(num_channels=self.C, logs_eps=logs_eps, position=position,
